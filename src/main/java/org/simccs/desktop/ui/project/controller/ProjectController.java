 ...
 *
*/
package org.simccs.desktop.ui.project.controller;
    ...
    public void initialize() {
        ...
        saveButton.setOnMouseClicked(event -> {
            try {
                ...
                stage.close();
                SimCCSEventBus.getInstance().post(new SimCCSEvent(SimCCSEvent.SimCCSEventType.PROJECT_CREATED,project));
            } catch (Exception e) {
                e.printStackTrace();
                SimCCSDialogHelper.showExceptionDialogAndWait(e, "Exception Dialog", saveButton.getScene().getWindow(),
