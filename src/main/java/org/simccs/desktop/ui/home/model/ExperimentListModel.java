 ...
 *
*/
package org.simccs.desktop.ui.home.model;
...
public class ExperimentListModel {
    ...
    public ExperimentListModel(ExperimentSummaryModel experimentSummaryModel) throws TException {
        ...
        this.createdTime = new SimpleObjectProperty<>(LocalDateTime.ofEpochSecond(experimentSummaryModel
                .getCreationTime() / 1000, 0, SimCCSContext.getInstance().getTimeZoneOffset()));
    ...
    @Subscribe
    public void listenSimCCSEvents(SimCCSEvent event){
        if (event.getEventType().equals(SimCCSEvent.SimCCSEventType.EXPERIMENT_DELETED)) {
            ...
            if(event.getPayload() instanceof  ExperimentModel){
                ...
                if(getId().equals(updatedExperimentModel.getExperimentId())){
                    try{
                        ...
                        e.printStackTrace();
                        SimCCSDialogHelper.showExceptionDialog(e,"Exception Dialog", null, "Failed updating experiment" +
